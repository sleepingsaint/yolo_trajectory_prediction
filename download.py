...
# file ids
links = {
    "1C3Kqqu9gDXNNXr5WDpmhGTr-UaQ2ckqQ": ["oldobj_detection.weights", "Trajectory/detector/YOLOv3/weight/"],
    ...
    "1MlXnCSjD5yOfxnnJMkruE0rCgLCMZJlB": ["ckpt.t7", "Trajectory/deep_sort/deep/checkpoint/"],
}
