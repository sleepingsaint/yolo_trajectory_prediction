...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot',default = 'test_images', help='Path to images')
        ...
        parser.add_argument('--cfg_file', default='lib/configs/resnext50_32x4d_diversedepth_regression_vircam',
                            help='Set model and dataset config files')
